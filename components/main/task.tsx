...
export default function Testimonial() {
  ...
  return (
    ...
    >
      <div className="w-full h-full grid grid-cols-1 md:grid-cols-2  md:grid-rows-2 gap-x-20 gap-y-10 p-6 md:p-14 justify-start items-start">
        ...
        <div className="flex flex-col gap-4">
          <div className="font-mulish text-lg md:text-lg font-bold tracking-wide">Design</div>
        ...
        <div className="flex flex-col gap-4">
          <div className="font-mulish text-lg md:text-lg font-bold tracking-wide">Development</div>
          <div className="font-nunito text-xs md:text-sm">
        ...
        <div className="flex flex-col gap-4">
          <div className="font-mulish text-lg md:text-lg font-bold tracking-wide">Deployment</div>
          <div className="font-nunito text-xs md:text-sm">
