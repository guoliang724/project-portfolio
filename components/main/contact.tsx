...
export default function Contact() {
  ...
  return (
    ...
    >
      <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 md:grid-rows-1 gap-10 md:gap-20 p-6 md:p-14 justify-center items-center">
        ...
        <div className="font-nunito text-xs md:text-sm tracking-wide">
